...
section .bss
    ...
    sum resb 6     ; space to store the result (up to 6 digits, including possible carry)
...
convert_to_string:
    ...
    ; Output: sum contains the string representation of the number
    mov edi, sum        ; Point EDI to the result buffer (sum)
    mov ebx, 10         ; Store 10 in EBX (used for division)
    mov ecx, 6          ; Set ECX to the maximum number of digits (including null terminator)
