...
section .bss
    ...
    quotient resb 11 ; space to store the quotient (up to 10 digits, including a possible sign and null terminator)
...
_start:
    ...
    ; Check if the second number (divisor) is zero
    cmp eax, 0
    je division_by_zero
    ...
    ; Convert the quotient back to a string
...
convert_to_string:
    ...
    ; Output: quotient contains the string representation of the number
    mov edi, quotient   ; Point EDI to the result buffer (quotient)
